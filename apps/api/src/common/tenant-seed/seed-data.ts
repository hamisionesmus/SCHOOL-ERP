...
export const ROLE_DEFINITIONS: { name: string; description: string; permissions: string[] }[] = [
  {
    ...
    permissions: [
      ...
      code('TRANSPORT', 'PROPOSE'),
      code('INVENTORY', 'MANAGE'),
      code('HEALTH', 'MANAGE'),
      code('HEALTH', 'ISSUE_SICK_SHEET'),
      code('CALENDAR', 'MANAGE'),
      code('DISCIPLINE', 'MANAGE'),
      code('SETTINGS', 'MANAGE'),
      code('BIOMETRIC', 'MANAGE'),
      code('TICKET', 'MANAGE'),
      code('STUDENT', 'VIEW'),
      code('STUDENT', 'CREATE'),
      code('STUDENT', 'EDIT'),
